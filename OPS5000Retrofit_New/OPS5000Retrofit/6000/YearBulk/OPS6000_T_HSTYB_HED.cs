//////////////////////////////////////////////////////////////////////
// File Name     ：OPS6000_T_HSTYB_HED.cs
// System Name   ：OPS5000 Retrofit System
// Description   ：OPS6000_T_HSTYB_HED file
// Creator       ：CongNC
...
namespace OPS5000Retrofit
{
    ...
    class OPS6000_T_HSTYB_HED
    {
        ...
        public OPS6000_T_HSTYB_HED()
        {
            ...
            indx = new OPS6000_T_HSTYB_IDX[3];
            for (int i = 0; i < 3; i++)
            {
                indx[i] = new OPS6000_T_HSTYB_IDX();
            }
            yobi02_s = new short[224];
            for (int i = 0; i < 224; i++)
            {
