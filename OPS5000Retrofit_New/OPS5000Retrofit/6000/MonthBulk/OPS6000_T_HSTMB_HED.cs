//////////////////////////////////////////////////////////////////////
// File Name     ：OPS6000_T_HSTMB_HED.cs
// System Name   ：OPS5000 Retrofit System
// Description   ：OPS6000_T_HSTMB_HED file
// Creator       ：CongNC
...
namespace OPS5000Retrofit
{
    ...
    class OPS6000_T_HSTMB_HED
    {
        ...
        public OPS6000_T_HSTMB_HED()
        {
            ...
            indx = new OPS6000_T_HSTMB_IDX[3];
            for (int i = 0; i < 3; i++)
            {
                indx[i] = new OPS6000_T_HSTMB_IDX();
            }
            chgmon_s = 0;
            yobi02_s = new short[223];
        }
    }
}
