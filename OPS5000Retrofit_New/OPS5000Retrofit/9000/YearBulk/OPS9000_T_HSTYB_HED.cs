//////////////////////////////////////////////////////////////////////
// File Name     ：OPS9000_T_HSTYB_HED.cs
...
namespace OPS5000Retrofit
{
    ...
    class OPS9000_T_HSTYB_HED
    {
        ...
        /// Index
        /// </summary>
        public OPS9000_T_HSTYB_IDX[] indx { get; set; }
        ...
        public OPS9000_T_HSTYB_HED()
        {
            ...
            indx = new OPS9000_T_HSTYB_IDX[6];
            for (int i = 0; i < 6; i++)
            {
                indx[i] = new OPS9000_T_HSTYB_IDX();
            }
            yobi02_s = new short[200];
            for (int i = 0; i < 200; i++)
            {
