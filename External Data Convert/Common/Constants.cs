...
namespace OPS5000Retrofit.Common
{
    ...
    public static class Constants
    {
        ...
        /// keiki ops90000
        /// </summary>
        public const int CNF_KEIKI_N = 512;

        /// <summary>
        /// station no
        /// </summary>
        public const int CNF_STATION_N = 32;

        public const int CNF_TRD_PEN_N = 8;

        public const int CNF_TRD_SPH_N = 14400;

        public const int CNF_TRD_HIS_N = 480;
        #endregion
